				  ...
				  <div class="card" style="border-radius: 1rem;">
					<div class="row g-0">
					  <div class="col-md-6 col-lg-5 d-none d-md-block">
						<img src="Avocado/imagini/Log-in.jpg" alt="login form" class="img-fluid h-100 w-100" style="border-radius: 1rem 0 0 1rem;" />
					  </div>
					  <div class="col-md-6 col-lg-7 d-flex align-items-center">
						...
						<form action="<%= request.getContextPath() %>/register" method="post">
							...
							<h5 class="form-title fw-normal mb-3 pb-3" >Create your account</h5>
							...
							<div class="form-group mb-0">
								...
								<div class="form-outline mb-4">
									  <input type="text" name="number" class="form-control form-control-lg" placeholder="Phone Number">
								</div>
				
								<div class="pt-1 mb-3">
									<button class="btn btn-dark btn-lg btn-block btn-form" type="submit" name="Submit" style="font-size: 18px;">SignUp</button>
								</div>
				
								<p class="mb-3 pb-lg-2">Already have an account? <a href="/Login.jsp">LogIn</a></p>
							</div>
						</form>
						</div>
					  </div>
